...
The public API lives at the module root (`github.com/go-ruby-racc/racc`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `racc`, while the surface follows
...
```go
import "github.com/go-ruby-racc/racc"
```
...
- **[pkg.go.dev/github.com/go-ruby-racc/racc](https://pkg.go.dev/github.com/go-ruby-racc/racc)**

The module's [README](https://github.com/go-ruby-racc/racc#readme) carries worked
