# go-ruby-racc documentation

**Pure-Go, MRI-4.0.5-faithful Ruby racc (no cgo)**

`go-ruby-racc/racc` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `racc`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-racc/racc`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `racc`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-racc/racc
```
...
| Repo | What it is |
| --- | --- |
| [`racc`](https://github.com/go-ruby-racc/racc) | the library — Ruby's `racc` in pure Go |
| [`docs`](https://github.com/go-ruby-racc/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-racc.github.io`](https://github.com/go-ruby-racc/go-ruby-racc.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-racc/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-racc/racc](https://github.com/go-ruby-racc/racc).
