...
`go-ruby-racc/racc` reimplements Ruby's `racc` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-racc/racc` directly, with no Ruby runtime;
